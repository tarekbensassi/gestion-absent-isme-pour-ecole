...
public class EnvoyerMessageAdmin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String id_destin = request.getParameter("id_destin");
        ...
        try {
            if (bt1.equals("Envoyer")) {
                ...
                edite.EnvoyerMessage(titre, message, dateActuel, Integer.valueOf(id_destin), Integer.valueOf(LoginAdmin.identifiantAdmin),Integer.valueOf(ty_destin),3, 0);
