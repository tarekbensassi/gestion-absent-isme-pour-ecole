...
<html>
    ...
    <body>
        <%
            ...
            Iterator it1 = ld.det_Message_recus(Integer.valueOf(LoginServlet.identifiantEtudiant), 2, Integer.valueOf(num_msg));
            int j = 0;
            String titre = "";
            String contenu = "";
            String Dateaj = "";
        ...
        <div class="container-fluid" id="pcont">
            ...
            <div class="cl-mcont">
                <div class="block-flat">
                    ...
                    <input disabled="true" type="text" style="margin: 0px -302.5px 0px 0px; width: 882px; height: 30px;" name="nom" value="<%=titre%>" class="form-control" required placeholder="Titre cours" />
                    <div><br> </div>
            ...
            <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModal_msg" class="modal fade">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <input type="text" name="id_user" value="<%=id_exp%>"/>      
                        <input type="text" name="ty_destin" value="<%=id_ty_exp%>"/>      
                        <input type="text" name="ty_exp" value="2"/>      
