                    ...
                    <div class="tab-container">
                        ...
                        <div class="tab-content">
                            <div id="home" class="tab-pane cont active">
                                <table class="no-border no-strip information">
                                    <tbody class="no-border-x no-border-y">
                                        ...
                                        <tr>
                                            <td style="width:20%;" class="category"><strong>Information d'etude</strong></td>
                                            <td>
                                                <table class="no-border no-strip skills">
                                                    <tbody class="no-border-x no-border-y">
                                                        <tr><td style="width:20%;"><b>Filliere</b></td><td><%=filliere%></td></tr>
                                                        <tr><td style="width:20%;"><b>Niveau</b></td><td><%=niveau%></td></tr>
                            ...
                            <div id="settings" class="tab-pane">
                                <form role="form" class="form-horizontal" action="ModifierEtudiant" method="POST">
