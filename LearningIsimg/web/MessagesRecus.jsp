                                    ...
                                    <table class="table table-bordered" id="datatable" >
                                        ...
                                        <tbody>
                                            <%
                                                ...
                                                Iterator it1 = ld.liste_Message_recus_prof(Integer.valueOf(LoginServlet.identifiantEtudiant), 2);
                                                int j = 0;
                                                int etat = 0;
                                                String titre = "";
                                                String contenu = "";
                                            ...
                                            <tr class="gradeA">
                                                ...
                                                <td>
                                                    <form action="DetailleMsg" method="POST">   
                                                        ...
                                                        <input type="hidden" name="type" value="etu">
                                                    </form>
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <input type="hidden" name="msg_recus" value="msg_recus_et">
