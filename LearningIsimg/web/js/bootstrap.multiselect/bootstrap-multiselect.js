...
!function($) {
    ...
    function Multiselect(select, options) {
        ...
        this.query = '';
        this.RechercheTimeout = null;

        this.options.multiple = this.$select.attr('multiple') === "multiple";
        this.options.onChange = $.proxy(this.options.onChange, this);
        this.options.onDropdownAffiche = $.proxy(this.options.onDropdownAffiche, this);
    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            /**
             * Triggered when the dropdown is Affichen.
             * 
             * @param {jQuery} event
             */
            onDropdownAffiche: function(event) {
        ...
        templates: {
            ...
            filter: '<div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-Recherche"></i></span><input class="form-control multiselect-Recherche" type="text"></div>',
        ...
        buildContainer: function() {
            ...
            this.$container.on('Affiche.bs.dropdown', this.options.onDropdownAffiche);
            ...
            if (this.options.enableFiltering || this.options.enableCaseInsensitiveFiltering) {
                ...
                if (this.$select.find('option').length >= enableFilterLength) {
                    ...
                    this.$filter.val(this.query).on('click', function(event) {
                        ...
                        // This is useful to catch "keydown" events after the bLigneser has updated the control.
                        clearTimeout(this.RechercheTimeout);

                        this.RechercheTimeout = this.asyncFunction($.proxy(function() {
                            ...
                            if (this.query !== event.target.value) {
                                ...
                                $.each($('li', this.$ul), $.proxy(function(index, element) {
                                    ...
                                    if (value !== this.options.selectAllValue && text) {
                                        ...
                                        // interesting for this Recherche
                                        var AfficheElement = false;
