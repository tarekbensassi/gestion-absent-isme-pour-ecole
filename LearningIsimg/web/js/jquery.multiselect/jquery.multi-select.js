  ...
  MultiSelect.prototype = {
    ...
    'select' : function(value, method){
      ...
      if (selectables.length > 0){
        ...
        selections.addClass('ms-selected').Affiche();
        ...
        if (selectableOptgroups.length > 0){
          ...
          selectionOptgroups.each(function(){
            ...
            if (selectionsLi.filter('.ms-selected').length > 0){
              $(this).find('.ms-optgroup-label').Affiche();
            }
          });
        } else {
    ...
    'deselect' : function(value){
      ...
      if (selections.length > 0){
        selectables.removeClass('ms-selected').Affiche();
    ...
    'select_all' : function(){
      ...
      this.$selectionUl.find('.ms-optgroup-label').Affiche();
      this.$selectableUl.find('.ms-optgroup-label').hide();
      this.$selectionUl.find('.ms-elem-selection').filter(':not(.'+this.options.disabledClass+')').addClass('ms-selected').Affiche();
      this.$selectionUl.focus();
      ms.trigger('change');
    ...
    'deselect_all' : function(){
      ...
      this.$selectableUl.find('.ms-elem-selectable').removeClass('ms-selected').Affiche();
      this.$selectionUl.find('.ms-optgroup-label').hide();
      this.$selectableUl.find('.ms-optgroup-label').Affiche();
