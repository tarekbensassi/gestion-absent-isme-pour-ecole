var App = function () {
  ...
  var dashboard = function(){
    ...
    function AfficheTooltip(x, y, contents) {
    ...
    if ($('#site_statistics').size() != 0) {
      ...
      $('#site_statistics_content').Affiche();
      ...
      var plot_statistics = $.plot($("#com_stats"), [{
        data: data_com, AfficheLabels: true, labels: data_com, labelPlacement: "below", canvasRender: true, cColor: "#FFFFFF" 
      }
      ], {
        series: {
          lines: {
      ...
      $("#site_statistics").bind("plothover", function (event, pos, item) {
        ...
        if (item) {
          if (previousPoint != item.dataIndex) {
            ...
            AfficheTooltip(item.pageX, item.pageY,
  ...
  var nestable = function(){
    //Watch for list changes and Affiche serialized output
  ...
  var charts = function(){
    ...
    if ($('#site_statistics').size() != 0) {
      ...
      var plot_statistics = $.plot($("#chart3"), [{
        data: data_com, AfficheLabels: true, label: "New Visitors", labelPlacement: "below", canvasRender: true, cColor: "#FFFFFF" 
      },{
        data: data_com2, AfficheLabels: true, label: "Old Visitors", labelPlacement: "below", canvasRender: true, cColor: "#FFFFFF" 
      }
      ], {
        series: {
          lines: {
  ...
  return {
    ...
    init: function (options) {
      ...
      if(config.hiddenElements){
      	/*Dropdown Affichen event*/
        $('.dropdown').on('Affichen.bs.dropdown', function () {
          $(".nscroller").nanoScroller();
        });
          
        /*Tabs refresh hidden elements*/
        $('.nav-tabs').on('Affichen.bs.tab', function (e) {
          $(".nscroller").nanoScroller();
        });
      }
