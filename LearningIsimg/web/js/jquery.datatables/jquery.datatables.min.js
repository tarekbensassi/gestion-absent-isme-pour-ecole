    ...
    var L = function(h) {
        var j = function(e) {
            function o(a, b) {
                ...
                a.aoColumns.push(c);
                if (a.aoPreRechercheCols[d] === n || null === a.aoPreRechercheCols[d])
                    a.aoPreRechercheCols[d] = h.extend({}, j.models.oRecherche);
                else if (c = a.aoPreRechercheCols[d],
                    ...
                    if (0 !== a.aiDisplay.length) {
                        ...
                        for (; g < d; g++) {
                            ...
                            if (0 !== f) {
                                ...
                                e._sLignestripe != o && (h(j).removeClass(e._sLignestripe).addClass(o), e._sLignestripe = o)
                            }
                            ...
                            if (0 !== c)
                                for (e = 0; e < c; e++)
                                    if (j == a.aoOpenLignes[e].nParent) {
                                        b.push(a.aoOpenLignes[e].nTr);
                                        break
                                    }
                        }
                    } else
            ...
            function aa(a) {
                a.oFeatures.bSort ? O(a, a.oPreviousRecherche) : a.oFeatures.bFilter ? K(a, a.oPreviousRecherche) : (y(a), x(a))
            }
            function xa(a) {
                var b = h("<div></div>")[0];
            ...
            function Ea(a) {
                ...
                if (!1 !== a.oFeatures.bFilter) {
                    c.push({name: "sRecherche", value: a.oPreviousRecherche.sRecherche});
                    c.push({name: "bRegex", value: a.oPreviousRecherche.bRegex});
                    for (f = 0; f < b; f++)
                        c.push({name: "sRecherche_" + f, value: a.aoPreRechercheCols[f].sRecherche}), c.push({name: "bRegex_" + f, value: a.aoPreRechercheCols[f].bRegex}), c.push({name: "bRechercheable_" + f, value: a.aoColumns[f].bRechercheable})
                }
                if (!1 !==
                        a.oFeatures.bSort) {
                    var e = 0;
            ...
            function za(a) {
                var b = a.oPreviousRecherche, c = a.oLanguage.sRecherche, c = -1 !== c.indexOf("_INPUT_") ? c.replace("_INPUT_", '<input type="text" />') : "" === c ? '<input type="text" />' : c + ' <input type="text" />', d = l.createElement("div");
                d.className = a.oClasses.sFilter;
                d.innerHTML = "<label>" + c + "</label>";
                a.aanFeatures.f || (d.id = a.sTableId + "_filter");
                c = h('input[type="text"]', d);
                d._DT_Input = c[0];
                c.val(b.sRecherche.replace('"', "&quot;"));
                c.bind("keyup.DT", function() {
                    ...
                    d != b.sRecherche && K(a, {sRecherche: d, bRegex: b.bRegex, bSmart: b.bSmart, bCaseInsensitive: b.bCaseInsensitive})
                });
            ...
            function K(a, b, c) {
                var d = a.oPreviousRecherche, i = a.aoPreRechercheCols, f = function(a) {
                    d.sRecherche = a.sRecherche;
                    d.bRegex = a.bRegex;
                    d.bSmart = a.bSmart;
                ...
                if (a.oFeatures.bServerSide)
                    ...
                    Ga(a, b.sRecherche, c, b.bRegex, b.bSmart, b.bCaseInsensitive);
                    f(b);
                    for (b = 0; b < a.aoPreRechercheCols.length; b++)
                        Ha(a, i[b].sRecherche, b, i[b].bRegex, i[b].bSmart, i[b].bCaseInsensitive);
                    Ia(a)
                }
                a.bFiltered = !0;
            ...
            function Ia(a) {
                for (var b = j.ext.afnFiltering, c = r(a, "bRechercheable"), d = 0, i = b.length; d < i; d++)
            ...
            function Ga(a, b, c, d, i, f) {
                d = ma(b, d, i, f);
                i = a.oPreviousRecherche;
                c || (c = 0);
                0 !== j.ext.afnFiltering.length && (c = 1);
                if (0 >= b.length)
                    a.aiDisplay.splice(0, a.aiDisplay.length), a.aiDisplay = a.aiDisplayMaster.slice();
                else if (a.aiDisplay.length == a.aiDisplayMaster.length || i.sRecherche.length > b.length || 1 == c || 0 !== b.indexOf(i.sRecherche)) {
                    a.aiDisplay.splice(0,
                            a.aiDisplay.length);
                    la(a, 1);
                    for (b = 0; b < a.aiDisplayMaster.length; b++)
                        d.test(a.asDataRecherche[b]) && a.aiDisplay.push(a.aiDisplayMaster[b])
                } else
                    for (b = c = 0; b < a.asDataRecherche.length; b++)
                        d.test(a.asDataRecherche[b]) || (a.aiDisplay.splice(b - c, 1), c++)
            }
            function la(a, b) {
                if (!a.oFeatures.bServerSide) {
                    a.asDataRecherche = [];
                    for (var c = r(a, "bRechercheable"), d = 1 === b ? a.aiDisplayMaster : a.aiDisplay, i = 0, f = d.length; i < f; i++)
                        a.asDataRecherche[i] = na(a, Y(a, d[i], "filter", c))
                }
            }
            function na(a, b) {
                var c = b.join("  ");
            ...
            function Ja(a, b) {
                return"function" === typeof j.ext.ofnRecherche[b] ? j.ext.ofnRecherche[b](a) : null === a ? "" : "html" == b ? a.replace(/[\r\n]/g, " ").replace(/<.*?>/g, "") : "string" === typeof a ? a.replace(/[\r\n]/g, " ") : a
            }
            function oa(a) {
            ...
            function ba(a) {
                ...
                if (!1 === a.bInitialised)
                    ...
                    a.oFeatures.bSort ? O(a) : a.oFeatures.bFilter ? K(a, a.oPreviousRecherche) : (a.aiDisplay = a.aiDisplayMaster.slice(), y(a), x(a));
            ...
            function La(a) {
                var b = a.nScrollHead.getElementsByTagName("div")[0], c = b.getElementsByTagName("table")[0], d = a.nTable.parentNode, i, f, g, e, j, o, k, m, p = [], n = [], l = null !== a.nTFoot ? a.nScrollFoot.getElementsByTagName("div")[0] : null, R = null !== a.nTFoot ? l.getElementsByTagName("table")[0] : null, r = a.oBLigneser.bScrollOversize, s = function(a) {
                    k =
                            a.style;
                    k.paddingTop = "0";
                    k.paddingBottom = "0";
            ...
            function O(a, b) {
                ...
                a.oFeatures.bFilter ? K(a, a.oPreviousRecherche, 1) : (a.aiDisplay = a.aiDisplayMaster.slice(), a._iDisplayStart = 0, y(a), x(a))
            }
            function ia(a, b, c, d) {
                Ra(b, {}, function(b) {
            ...
            function ra(a) {
                if (a.oFeatures.bStateSave && !a.bDestroying) {
                    ...
                    var d = {iCreate: (new Date).getTime(), iStart: b ? 0 : a._iDisplayStart, iEnd: b ? a._iDisplayLength : a._iDisplayEnd, iLength: a._iDisplayLength, aaSorting: h.extend(!0, [], a.aaSorting),
                        oRecherche: h.extend(!0, {}, a.oPreviousRecherche), aoRechercheCols: h.extend(!0, [], a.aoPreRechercheCols), abVisCols: []};
                    b = 0;
                    for (c = a.aoColumns.length; b < c; b++)
                ...
                if (a.oFeatures.bStateSave) {
                    ...
                    if (c) {
                        ...
                        if (-1 === h.inArray(!1, d)) {
                            ...
                            h.extend(a.oPreviousRecherche, c.oRecherche);
                            h.extend(!0, a.aoPreRechercheCols, c.aoRechercheCols);
                            b.saved_aoColumns = [];
            ...
            function Ua(a) {
                var b = h('<div style="position:absolute; top:0; left:0; height:1px; width:1px; overflow:hidden"><div style="position:absolute; top:1px; left:1px; width:100px; overflow:scroll;"><div id="DT_BLigneserTest" style="width:100%; height:10px;"></div></div></div>')[0];
                l.body.appendChild(b);
                a.oBLigneser.bScrollOversize =
                        100 === h("#DT_BLigneserTest", b)[0].offsetWidth ? !0 : !1;
            ...
            this.fnClose =
                    function(a) {
                        for (var b = s(this[j.ext.iApiIndex]), c = 0; c < b.aoOpenLignes.length; c++)
                            if (b.aoOpenLignes[c].nParent == a)
                                return(a = b.aoOpenLignes[c].nTr.parentNode) && a.removeChild(b.aoOpenLignes[c].nTr), b.aoOpenLignes.splice(c, 1), 0;
                        return 1
                    };
            ...
            this.fnFilter = function(a, b, c, d, e, f) {
                ...
                if (g.oFeatures.bFilter) {
                    ...
                    if (f === n || null === f)
                        f = !0;
                    if (b === n || null === b) {
                        if (K(g, {sRecherche: a + "", bRegex: c, bSmart: d, bCaseInsensitive: f}, 1), e && g.aanFeatures.f) {
                            b = g.aanFeatures.f;
                            c = 0;
                            for (d = b.length; c < d; c++)
                                try {
                        ...
                        h.extend(g.aoPreRechercheCols[b], {sRecherche: a + "", bRegex: c, bSmart: d, bCaseInsensitive: f}), K(g, g.oPreviousRecherche, 1)
                }
            };
            ...
            this.fnOpen = function(a, b, c) {
                ...
                if (-1 !== h.inArray(a, e)) {
                    ...
                    d.aoOpenLignes.push({nTr: e, nParent: a});
                    return e
                }
            };
            ...
            this.fnSetColumnVis = function(a, b, c) {
                ...
                if (g[a].bVisible != b) {
                    ...
                    e = 0;
                    for (f = d.aoOpenLignes.length; e < f; e++)
                        d.aoOpenLignes[e].nTr.colSpan = t(d);
                    if (c === n || c)
                        k(d), x(d);
                    ra(d)
                }
            ...
            this.fnUpdate = function(a, b, c, d, e) {
                ...
                f.asDataRecherche[c] = na(f, Y(f, b, "filter", r(f, "bRechercheable")));
                (e === n || e) && k(f);
                (d === n || d) && aa(f);
                return 0
            };
            ...
            this.oApi = {_fnExternApiFunc: Va, _fnInitialise: ba, _fnInitComplete: $, _fnLanguageCompat: pa, _fnAddColumn: o, _fnColumnOptions: m, _fnAddData: H, _fnCreateTr: ea, _fnGatherData: ua, _fnBuildHead: va, _fnDrawHead: W, _fnDraw: x, _fnReDraw: aa, _fnAjaxUpdate: wa, _fnAjaxParameters: Ea, _fnAjaxUpdateDraw: Fa, _fnServerParams: ka, _fnAddOptionsHtml: xa, _fnFeatureHtmlTable: Ba, _fnScrollDraw: La, _fnAdjustColumnSizing: k, _fnFeatureHtmlFilter: za, _fnFilterComplete: K, _fnFilterCustom: Ia, _fnFilterColumn: Ha,
                _fnFilter: Ga, _fnBuildRechercheArray: la, _fnBuildRechercheRow: na, _fnFilterCreateRecherche: ma, _fnDataToRecherche: Ja, _fnSort: O, _fnSortAttachListener: ia, _fnSortingClasses: P, _fnFeatureHtmlPaginate: Da, _fnPageChange: qa, _fnFeatureHtmlInfo: Ca, _fnUpdateInfo: Ka, _fnFeatureHtmlLength: ya, _fnFeatureHtmlProcessing: Aa, _fnProcessingDisplay: E, _fnVisibleToColumnIndex: G, _fnColumnIndexToVisible: R, _fnNodeToDataIndex: I, _fnVisbleColumns: t, _fnCalculateEnd: y, _fnConvertToWidth: Ma, _fnCalculateColumnWidths: da, _fnScrollingWidthAdjust: Oa, _fnGetWidestNode: Na,
                ...
                _fnGetCellData: v, _fnSetCellData: F, _fnGetObjectDataFn: Q, _fnSetObjectDataFn: L, _fnApplyColumnDefs: ta, _fnBindAction: Ra, _fnExtend: Ta, _fnCallbackReg: z, _fnCallbackFire: A, _fnJsonString: Wa, _fnRender: S, _fnNodeToColumnIndex: fa, _fnInfoMacros: ja, _fnBLigneserDetect: Ua, _fnGetColumns: r};
            ...
            this.each(function() {
                ...
                if ("table" != this.nodeName.toLowerCase())
                    ...
                    p(g, e, "bSortCellsTop");
                    p(g, e, "iTabIndex");
                    p(g, e, "oRecherche", "oPreviousRecherche");
                    p(g, e, "aoRechercheCols", "aoPreRechercheCols");
        ...
        j.models.ext = {afnFiltering: [], afnSortData: [], aoFeatures: [],
            aTypes: [], fnVersionCheck: j.fnVersionCheck, iApiIndex: 0, ofnRecherche: {}, oApi: {}, oStdClasses: {}, oJUIClasses: {}, oPagination: {}, oSort: {}, sVersion: j.version, sErrMode: "alert", _oExternConfig: {iNextUnique: 0}};
        j.models.oRecherche = {bCaseInsensitive: !0, sRecherche: "", bRegex: !1, bSmart: !0};
        j.models.oRow = {nTr: null, _aData: [], _aSortData: [], _anHidden: [], _sLignestripe: ""};
        j.models.oColumn = {aDataSort: null, asSorting: null, bRechercheable: null, bSortable: null, bUseRendered: null, bVisible: null, _bAutoType: !0, fnCreatedCell: null, fnGetData: null,
        ...
        j.defaults = {aaData: null, aaSorting: [[0, "asc"]], aaSortingFixed: null, aLengthMenu: [10, 25, 50, 100], aoColumns: null, aoColumnDefs: null, aoRechercheCols: [], asStripeClasses: null, bAutoWidth: !0, bDeferRender: !1, bDestroy: !1, bFilter: !0, bInfo: !0, bJQueryUI: !1, bLengthChange: !0,
            ...
            fnRowCallback: null, fnServerData: function(e, j, m, k) {
                ...
                oPaginate: {sFirst: "Premiére", sLast: "Dernier", sNext: "Suivant", sPrevious: "Précédent"}, sEmptyTable: "Pas de données disponibles dans le tableau", sInfo: "Afficher _START_ à _END_ / _TOTAL_ entrées", sInfoEmpty: "Afficher 0 à 0 of 0 entrées", sInfoFiltered: "(filtered from _MAX_ total entries)", sInfoPostFix: "", sInfoThousands: ",", sLengthMenu: "Affiche _MENU_ entries", sLoadingRecords: "Loading...", sProcessing: "Processing...", sRecherche: "Recherche:", sUrl: "", sZeroRecords: "Aucun enregistrement correspondant trouvé"}, oRecherche: h.extend({}, j.models.oRecherche), sAjaxDataProp: "aaData",
        ...
        j.defaults.columns = {aDataSort: null, asSorting: ["asc", "desc"], bRechercheable: !0, bSortable: !0, bUseRendered: !0, bVisible: !0, fnCreatedCell: null, fnRender: null, iDataSort: -1, mData: null, mRender: null, sCellType: "td", sClass: "", sContentPadding: "", sDefaultContent: null, sName: "", sSortDataType: "std", sTitle: null, sType: null, sWidth: null};
        j.models.oSettings = {oFeatures: {bAutoWidth: null,
                bDeferRender: null, bFilter: null, bInfo: null, bLengthChange: null, bPaginate: null, bProcessing: null, bServerSide: null, bSort: null, bSortClasses: null, bStateSave: null}, oScroll: {bAutoCss: null, bCollapse: null, bInfinite: null, iBarWidth: 0, iLoadGap: null, sX: null, sXInner: null, sY: null}, oLanguage: {fnInfoCallback: null}, oBLigneser: {bScrollOversize: !1}, aanFeatures: [], aoData: [], aiDisplay: [], aiDisplayMaster: [], aoColumns: [], aoHeader: [], aoFooter: [], asDataRecherche: [], oPreviousRecherche: {}, aoPreRechercheCols: [], aaSorting: null, aaSortingFixed: null,
            asStripeClasses: null, asDestroyStripes: [], sDestroyWidth: 0, aoRowCallback: [], aoHeaderCallback: [], aoFooterCallback: [], aoDrawCallback: [], aoRowCreatedCallback: [], aoPreDrawCallback: [], aoInitComplete: [], aoStateSaveParams: [], aoStateLoadParams: [], aoStateLoaded: [], sTableId: "", nTable: null, nTHead: null, nTFoot: null, nTBody: null, nTableWrapper: null, bDeferLoading: !1, bInitialised: !1, aoOpenLignes: [], sDom: null, sPaginationType: "two_button", iCookieDuration: 0, sCookiePrefix: "", fnCookieCallback: null, aoStateSave: [], aoStateLoad: [],
        ...
        h.extend(j.ext.oPagination, {two_button: {fnInit: function(e, j, m) {
                ...
                }}, iFullNumbersAffichePages: 5, full_numbers: {fnInit: function(e, j, m) {
                ...
                fnUpdate: function(e, o) {
                    if (e.aanFeatures.p) {
                        var m = j.ext.oPagination.iFullNumbersAffichePages, k = Math.floor(m / 2), l = Math.ceil(e.fnRecordsDisplay() / e._iDisplayLength), n = Math.ceil(e._iDisplayStart / e._iDisplayLength) + 1, t = "", r, B = e.oClasses, u, M = e.aanFeatures.p, L = function(h) {
