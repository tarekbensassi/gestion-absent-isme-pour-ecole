...
!function ($) {
  ...
  ParsleyUI.prototype = {
    ...
    */
    , manageError: function ( constraint ) {
      // display ulError container if it has been removed previously (or never Affichen)
      ...
      // add liError if not Affichen. Do not add more than once custom errorMessage if exist
  ...
  ParsleyField.prototype = {
    ...
    */
    , validate: function ( errorBubbling ) {
      ...
      if ( 'undefined' !== typeof errorBubbling ? errorBubbling : this.options.AfficheErrors ) {
    ...
    */
    , validate: function ( event ) {
      ...
      if ( this.focusedField && !valid ) {
        ...
        // Just focus on the field and let the bLigneser do the rest
        } else {
  ...
  */
  $.fn.parsley.defaults = {
    ...
    , errorMessage: false                       // Customize an unique error message Afficheed if one constraint fails
    , validators: {}                            // Add your custom validators functions
    , AfficheErrors: true                          // Set to false if you don't want Parsley to display error messages
