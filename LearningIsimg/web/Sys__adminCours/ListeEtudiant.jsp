                                            ...
                                            <table class="table table-bordered" id="datatable" >
                                                ...
                                                <tbody>
                                                    <%
                                                        ...
                                                        Iterator it1 = ld.liste_tous_etudiant();
                                                        int j = 0;
                                                        String nom_et = "";
                                                        String prenom_et = "";
                                                        String email = "";
                                                    ...
                                                    <tr class="gradeA">
                                                        ...
                                                        <td>
                                                            <button title="Modifier" class="btn btn-primary"  ><a href="../Sys__adminCours/DetailleEtudiant.jsp?id_etu=<%=of.getIdEtudiant()%>"><i class="fa fa-edit"></i></a></button>
                                                                    ...
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                ...
                                                                                <p>Voulez vous supprimer l'eetudiant <%=nom_et%> <%=prenom_et%> ?</p>
