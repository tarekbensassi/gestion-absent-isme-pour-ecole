    ...
    <body>
        ...
        <div id="cl-wrapper">
            ...
            <div class="container-fluid" id="pcont">
                <div class="page-head">
                    <h2>liste des messages envoyer</h2>
                                        ...
                                        <table class="table table-bordered" id="datatable" >
                                            ...
                                            <tbody>
                                                <%
                                                    ...
                                                    Iterator it1 = ld.liste_Message_envoyer_prof(Integer.valueOf(LoginAdmin.identifiantAdmin), 3);
                                                    int j = 0;
                                                    String titre = "";
                                                    String contenu = "";
                                                    String Dateaj = "";
                                                ...
                                                <tr class="gradeA">
                                                    ...
                                                    <td>
                                                        ...
                                                        <button href="#myModal_supp<%=j%>"  data-toggle="modal" class="btn btn-danger"><i class="fa  fa-trash-o"></i></button>
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            ...
                                                                            <input type="hidden" name="msg_recus" value="msg_envoyer_admin">
        ...
        <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModal_supp" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    ...
                    <div class="modal-body">
                        <input type="hidden" name="id_annon" value="">
                        <p>Voulez vous supprimer le message ?</p>
                        <div class="modal-footer">
                            <button data-dismiss="modal" class="btn btn-danger" type="button">Annuler</button>
                            <input name="Envoyer1" type="submit" value="Oui" class="btn btn-success">
