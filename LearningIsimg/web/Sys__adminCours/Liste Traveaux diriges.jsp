                                            ...
                                            <tbody>
                                                ...
                                                <tr class="gradeA">
                                                    ...
                                                    <td>
                                                        ...
                                                        <button title="Modifier" class="btn btn-primary"  ><a href="../Sys__adminCours/ModifierCours.jsp?id_cours=<%=of.getIdDocumentTd()%>&&types=2"><i class="fa fa-edit"></i></a></button>
