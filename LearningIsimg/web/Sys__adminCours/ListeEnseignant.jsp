                                            ...
                                            <table class="table table-bordered" id="datatable" >
                                                ...
                                                <tbody>
                                                    <%
                                                        ...
                                                        Iterator it1 = ld.liste_tous_enseignant();
                                                        int j = 0;
                                                        String nom_ens = "";
                                                        String prenom_ens = "";
                                                        String email = "";
                                                        ...
                                                        while (it1.hasNext()) {
                                                            ...
                                                            nom_ens = of.getNom();
                                                            prenom_ens = of.getPrenom();
                                                            email = of.getEmail();
                                                            télèphone = of.getTel1();
                                                    %>
                                                    <tr class="gradeA">
                                                        <td><%=nom_ens%></td>
                                                        <td><%=prenom_ens%></td>
                                                        ...
                                                        <td>
                                                            <button title="Modifier" class="btn btn-primary"  ><a href="../Sys__adminCours/DetailleEnseignant.jsp?id_ens=<%=of.getIdEnseignant()%>"><i class="fa fa-edit"></i></a></button>
                                                            <button title="Supprimer" href="#myModal_supp<%=j%>" class="btn btn-danger" data-toggle="modal" ><i class="fa  fa-trash-o"></i></button>
                                                            <form action="../SupprimerEnseignant" method="POST">
                                                                    ...
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <input type="hidden" name="id_ens" value="<%=of.getIdEnseignant()%>">
                                                                                <p>Voulez vous supprimer l'enseignant <%=nom_ens%> <%=prenom_ens%> ?</p>
