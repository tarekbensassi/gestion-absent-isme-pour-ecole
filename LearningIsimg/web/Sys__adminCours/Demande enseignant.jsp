    ...
    <body>
        ...
        <div id="cl-wrapper">
            ...
            <div class="container-fluid" id="pcont">
                <div class="page-head">
                    <h2>liste Demandes enseignants</h2>
                </div>		
                <div class="cl-mcont">
                    <div class="row">
                        <div class="col-md-12">
                                        ...
                                        <table class="table table-bordered" id="datatable" >
                                            ...
                                            <tbody>
                                                <%
                                                    ...
                                                    Iterator it1 = ld.liste_Demande_enseignant(0);
                                                    int j = 0;
                                                    String nom_en = "";
                                                    String prenom_en = "";
                                                ...
                                                <tr class="gradeA">
                                                    ...
                                                    <td><a href="#myModal_conf<%=j%>"  data-toggle="modal">repondre a demande</a>
                                                        <form action="../ConfirmationDemandeEnseignant" method="POST">
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            ...
                                                                            <h4 class="modal-title">Repondre a la demande d'enseignant</h4>
                                                                        </div>
                                                                        <div class="modal-body">
                                                                            <input type="hidden" name="id_en" value="<%=of.getIdEnseignant()%>">
                                                                            <p>Voulez vous accepter l'inscription de l'etudiant <%=nom_en%> <%=prenom_en%> ?</p>
