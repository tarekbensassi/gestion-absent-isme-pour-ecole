                                        ...
                                        <table class="table table-bordered" id="datatable" >
                                            ...
                                            <tbody>
                                                <%
                                                    ...
                                                    Iterator it1 = ld.liste_Message_envoyer_prof(Integer.valueOf(LoginServlet.identifiantEnseignant), 1);
                                                    int j = 0;
                                                    String titre = "";
                                                    String contenu = "";
                                                    String Dateaj = "";
                                                ...
                                                <tr class="gradeA">
                                                    ...
                                                    <td><%=Dateaj%></td>
                                                    <td>
                                                        <button href="#"  data-toggle="modal" class="btn btn-success "><i class="fa  fa-eye"></i></button>
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            ...
                                                                            <input type="hidden" name="msg_recus" value="msg_envoyer_ens">
