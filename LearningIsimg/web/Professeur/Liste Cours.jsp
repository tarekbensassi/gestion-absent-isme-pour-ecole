                                        ...
                                        <table class="table table-bordered" id="datatable" >
                                            ...
                                            <tbody>
                                                <%
                                                    ...
                                                    Iterator it1 = ld.liste_cours_prof(Integer.valueOf(LoginServlet.identifiantEnseignant));
                                                    int j = 0;
                                                    String titre = "";
                                                    String Description = "";
                                                    String Dateaj = "";
                                                ...
                                                <tr class="gradeA">
                                                    ...
                                                    <td>
                                                        ...
                                                        <button title="Modifier" class="btn btn-primary"  ><a href="../Professeur/ModifierCours.jsp?id_cours=<%=of.getIdDocCours()%>&&types=1"><i class="fa fa-edit"></i></a></button>
