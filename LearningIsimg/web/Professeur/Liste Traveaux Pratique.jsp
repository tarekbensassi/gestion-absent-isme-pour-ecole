    ...
    <body>
        ...
        <div id="cl-wrapper">
            ...
            <div class="container-fluid" id="pcont">
                <div class="page-head">
                    <h2>liste des Traveaux Pratiques</h2>
                </div>		
                <div class="cl-mcont">
                    <div class="row">
                        <div class="col-md-12">
                                        ...
                                        <table class="table table-bordered" id="datatable" >
                                            ...
                                            <tbody>
                                                <%
                                                    ...
                                                    Iterator it1 = ld.liste_TP(Integer.valueOf(LoginServlet.identifiantEnseignant));
                                                    int j = 0;
                                                    String titre = "";
                                                    String Description = "";
                                                    String Dateaj = "";
                                                    ...
                                                    while (it1.hasNext()) {
                                                        DocumentTp of = (DocumentTp) it1.next();
                                                ...
                                                <tr class="gradeA">
                                                    ...
                                                    <td>
                                                        ...
                                                        <button title="Modifier" class="btn btn-primary"  ><a href="ModifierCours.jsp?id_cours=<%=of.getIdDocumentTp()%>&&types=3"><i class="fa fa-edit"></i></a></button>
                                                        <button title="Supprimer" href="#myModal_supp<%=j%>" class="btn btn-danger" data-toggle="modal" ><i class="fa  fa-trash-o"></i></button>
                                                        <form action="../SupprimerTp" method="POST">
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            ...
                                                                            <h4 class="modal-title">Supprimer TP</h4>
                                                                        </div>
                                                                        <div class="modal-body">
                                                                            <input type="hidden" name="id_cour" value="<%=of.getIdDocumentTp()%>">
                                                                            <p>Voulez vous supprimer le TP?</p>
