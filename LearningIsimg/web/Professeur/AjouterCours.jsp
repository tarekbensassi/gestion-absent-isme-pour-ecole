                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="block-flat">
                                <form accept-charset="UTF-8" class="form-horizontal group-border-dashed" id="signupForm" method="POST" action="../AjouterCours" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" name="nom" class="form-control" required placeholder="Titre cours" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <select required class="form-control" name="matiere">
                                                <%
                                                    Iterator it_matiere = edite.liste_Matiere();
                                                    int j = 0;
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <select required class="form-control" name="filiere">
                                                <%
                                                    Iterator it_filliere = edite.liste_Filiere();
                                                    int x = 0;
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Cours</label>
