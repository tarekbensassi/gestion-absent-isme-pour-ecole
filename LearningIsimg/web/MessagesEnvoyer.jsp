                                    ...
                                    <table class="table table-bordered" id="datatable" >
                                        ...
                                        <tbody>
                                            <%
                                                ...
                                                Iterator it1 = ld.liste_Message_envoyer_prof(Integer.valueOf(LoginServlet.identifiantEtudiant), 2);
                                                int j = 0;
                                                int ms = 0;
                                                String titre = "";
                                                String contenu = "";
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <input type="hidden" name="id_msg" value="<%=ms%>">
                                                                        <input type="hidden" name="msg_recus" value="msg_envoyer_et">
