                        ...
                        <div class="block-flat">
                            ...
                            <div class="content">
                                <div class="table-responsive">
                                    <div class="header">
                                        <p><strong><h2>Bienvenue chères étudiants </h2></strong> <h2><%=nom%> <%=prenom%></h2></div>
                                    <div class="content">
                                        <h3><img src="images/amazon-kindle_with_books.jpg"/>De ce moment, aucuns problème aucun trac lors de vos recherches, votre cours, travaux pratiques
                                            et vos travaux dirigées sont maintenant disponibles Pour autres informations nous somme en service, 
                                            juste <a data-toggle="modal" href="#myModal_message">contacté nous.</a>
                                        </h3>
