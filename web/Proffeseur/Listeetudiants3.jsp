            ...
            <div id="content">
                ...
                <section class="style-default-bright">
                    <div class="section-header">
                        <h2 class="text-primary">Nombre d'absence</h2>
                    </div>
                    <div class="section-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body ">
                                        <form action="../ListeEtudiant">
                                            <div class="row">


                                                <div class="form-group">
                                                    <label for="select1" class="col-sm-2 control-label">Matiére</label>
                                                    <div class="col-sm-10">
                                                        <select id="select1" name="IdMatiere" class="form-control">
                                                            <%
                                                                Gestion gestion = new Gestion();
                                                                Iterator it_mod = gestion.listeMatiereModule(Integer.valueOf(idModule));
                                                                while (it_mod.hasNext()) {
                                                                    Matiere mat = (Matiere) it_mod.next();

                                                            %>
                                                            <option value="<%=mat.getIdMatiere()%>"><%=mat.getLibelle()%></option>
                                                            <%}%>
                                                        </select>
                                                        <input required type="hidden" value="<%=idClasse%>" id="IdClasse" name="SelectClasse">
                                                        <input required type="hidden" value="<%=idModule%>" id="IdModule" name="IdModule">
                                                        <input required type="hidden" value="<%=IdSem%>" id="IdModule" name="IdSemestre">
                                                ...
                                                <div class="card-actionbar">
                                                    <div class="card-actionbar-row">
                                                        <button type="submit" name="bt" value="3" class="btn btn-flat btn-primary ink-reaction">Suivant</button>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <ul id="main-menu" class="gui-controls">
                ...
                <li class="gui-folder">
                    ...
                    <ul>
                        ...
                        <li><a href="Listeetudiants1.jsp?nom=<%=nom %>&&prenom=<%=prenom %>" ><span class="title">Nombre d'absence</span></a></li>
