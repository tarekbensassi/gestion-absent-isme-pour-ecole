                ...
                <section>
                    ...
                    <div class="section-body">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <form class="form-horizontal" action="../AjouterModule">
                                    <div class="card">
                                        <div class="card-head style-primary">
                                            <header>Ajouter module</header>
                                        </div>
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="module" class="form-control" id="Firstname5">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <select id="select1" name="semes" class="form-control">
