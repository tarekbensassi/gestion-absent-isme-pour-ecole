...
<html lang="en">
    ...
    <body class="menubar-hoverable header-fixed menubar-pin ">
        <% String idmod = request.getParameter("idmod");
              ...
              if(module.getIdModule()==Integer.valueOf(idmod)){
                  lib=module.getLibelle();
                ...
                <section>
                    ...
                    <div class="section-body">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <form class="form-horizontal" method="post" action="../modmodule">
                                     <input type="hidden" value="<%=idmod%>" name="idmod">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label for="Firstname5" class="col-sm-2 control-label">Module</label>
                                                <div class="col-sm-10">
                                                    <input type="text" value="<%=lib%>" class="form-control" id="libellemodule" name="libelle">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label for="select1" class="col-sm-2 control-label">Semestre</label>
                                                <div class="col-sm-10">
                                                    <select id="select1" name="semestre" class="form-control">
                                        ...
                                        <div class="card-actionbar">
                                            <div class="card-actionbar-row">
                                                <button type="submit"  name="bt" value="modifModule" class="btn btn-flat btn-primary ink-reaction">Enregistrer</button>
                                                <button type="submit" class="btn btn-flat btn-danger ink-reaction">Annuler</button>
                                            </div>
                                        </div>
                                    </div><!--end .card -->
