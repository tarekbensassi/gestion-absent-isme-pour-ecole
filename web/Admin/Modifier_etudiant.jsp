...
<html lang="en">
 ...
 <% String id_et = request.getParameter("id_et");
    String id_us = request.getParameter("id_ut");
            ...
            Iterator it_et = g.listeEtudiant(Integer.valueOf(id_us));
            
            while (it_et.hasNext()) {
                Etudiant et = (Etudiant) it_et.next();
                carte = et.getCarteEtudiant();
            }
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <form class="form-horizontal" method="post" action="../Modifetudiant">
                                    <input type="hidden" value="<%=id_et%>" name="id_et">
                                    <input type="hidden" value="<%=id_us%>" name="id_ut">
                                    <div class="card">
                                        <div class="card-head style-primary">
                                            <header>Modifier etudiant</header>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="text"  value="<%=prenom%>" class="form-control" id="prenom" name="prenom">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text"  value="<%=tel%>" class="form-control" id="tel" name="tel">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="Username5" class="col-sm-2 control-label">E-mail</label>
                                                <div class="col-sm-10">
                                                    <input type="email"  value="<%=mail%>"class="form-control" id="email" name="mail">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="Username5" class="col-sm-2 control-label">Num Carte etudiant</label>
                                                <div class="col-sm-10">
                                                    <input type="text"  value="<%=carte%>" class="form-control" id="matricule" name="carte">
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-actionbar">
                                            <div class="card-actionbar-row">
                                                ...
                                                <button type="reset"  name="bt"  class="btn btn-flat btn-danger ink-reaction">Annuler</button>
                                            </div>
                                        </div>
                                    </div><!--end .card -->
