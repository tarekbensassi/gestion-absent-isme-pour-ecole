...
<%@page import="Model.Absenseignant"%>
    ...
    <body class="menubar-hoverable header-fixed menubar-pin ">
        ...
        <div id="base">
            ...
            <div id="content">
                ...
                <section class="style-default-bright">
                    <div class="section-header">
                        <h2 class="text-primary">Liste Absence Des enseignants</h2>
                    </div>
                                        ...
                                        <table id="datatable1" class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                <%
                                                    ...
                                                    Iterator it_user = gestion.listeUtilisateur(2);
                                                    int i = 0;
                                                    while (it_user.hasNext()) {
                                                        Utilisateur user = (Utilisateur) it_user.next();
                                                     Iterator it_et = gestion.listeEnseignant(Integer.valueOf(user.getIdUtilisateur()));
                                                              while (it_et.hasNext()) {
                                                                   Enseignant et = (Enseignant) it_et.next();
                                                                    Iterator it_et1 = gestion.listeabsEnseignant(Integer.valueOf(et.getIdEnseignant()));
                                                                    while (it_et1.hasNext()) {
                                                                   Absenseignant et1 = (Absenseignant) it_et1.next();

                                                %>
                                                <tr class="gradeX">
                                                    <td><input name="nom" value="<%= et1.getIdEnseignant() %>" type="hidden" readonly><%=user.getNom()%> <%=user.getPrenom()%></td>
                                                    <td> <%=user.getEmail()%></td>
                                                    <td> <%=user.getTel()%></td>
                                                   
                                                    
                                                    <td><%= et1.getDateseance() %> </td>
         ...
         <form action="../SuppElement" method="POST"> 
              <input required type="hidden" value="<%= et1.getIdAbs() %>" id="enseignet" name="ideng">
    <!-- Modal -->
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">Supprimer L'absence </h4>
          </div>
          <div class="modal-body">
           <p><h2>Voulez vous supprimer L'absence de <%= user.getNom()  + user.getPrenom() %> A la date  <%= et1.getDateseance() %> ?</h2></p>
          </div>
          <div class="modal-footer">
            
            <button type="Submit" name="bt" value="Enregistrer" class="btn btn-primary">Oui</button>
