...
<html lang="en">
            ...
            <div id="content">
                <section class="style-default-bright">
                    <div class="section-header">
                        <h2 class="text-primary">Liste des semestres</h2>
                    </div>
                                ...
                                <div class="table-responsive">
                                    <table id="datatable1" class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            %>
                                            <tr class="gradeX">
                                                <td><%=sem.getNumsemester()%></td>
                                                <td><%=sem.getDatedebutSemester()%></td>
                                                <td><%=sem.getDatefinSemester()%></td>
    ...
    <a data-toggle="modal" href="#myModal<%=i%>" >
          <input required type="hidden" value="<%= sem.getIdSemester() %>" id="enseignet" name="ids">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
           <P><h2>Voulez vous supprimer Semestre ?</h2></P>
          </div>
          <div class="modal-footer">
            
              <button type="submit" name="bt" value="suppsemester" class="btn btn-primary">Oui</button>
