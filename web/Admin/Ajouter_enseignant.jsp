    ...
    <body class="menubar-hoverable header-fixed menubar-pin ">
        ...
        <div id="base">
            ...
            <div id="content">
                ...
                <!-- BEGIN BLANK SECTION -->
                <section>
                    <form class="form-horizontal" action="../AjouterEnseignant" >
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="card">
                                        <div class="card-head style-primary">
                                            <header>Ajouter enseingant</header>
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input name="nom" type="text" class="form-control" id="Firstname5">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input name="prenom" type="text" class="form-control" id="Lastname5">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea name="adresse" type="text" class="form-control" id="Username5"></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="Username5" class="col-sm-2 control-label">Téléphone</label>
                                                <div class="col-sm-10">
                                                    <input name="tel" type="text" class="form-control" id="Username5">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="Username5" class="col-sm-2 control-label">E-mail</label>
                                                <div class="col-sm-10">
                                                    <input type="email" name="email" class="form-control" id="Username5">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="Username5" class="col-sm-2 control-label">Matricule</label>
                                                <div class="col-sm-10">
                                                    <input type="text" name="matricule" class="form-control" id="Username5">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="Username5" class="col-sm-2 control-label">Nom d'utilisateur</label>
                                                <div class="col-sm-10">
                                                    <input type="text" name="login" class="form-control" id="Username5">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="Password5" class="col-sm-2 control-label">Mot de passe</label>
                                                <div class="col-sm-10">
                                                    <input type="password" name="pwd" class="form-control" id="Password5">
                                                </div>
                                            </div>
                                        </div><!--end .card-body -->
