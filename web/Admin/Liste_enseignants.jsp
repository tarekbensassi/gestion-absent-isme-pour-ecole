...
<html lang="en">
            ...
            <div id="content">
                <section class="style-default-bright">
                    <div class="section-header">
                        <h2 class="text-primary">Liste des enseignants</h2>
                    </div>
                                    ...
                                    <table id="datatable1" class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            while (it_user.hasNext()) {
                                                ...
                                                Iterator it_enseignant = gestion.listeEnseignant(user.getIdUtilisateur());
                                                while (it_enseignant.hasNext()) {
                                                    Enseignant ens=(Enseignant) it_enseignant.next();
                                                
                                            %>
                                            <tr class="gradeX">
                                                <td><%=ens.getMatricule()%></td>
                                                <td><%=user.getNom()%></td>
                                           ...
                                           <a  href="Modifier_enseignant.jsp?id_ens=<%=ens.getIdEnseignant() %>&&id_ut=<%=user.getIdUtilisateur()%>"> 
    ...
    <form action="../SuppElement" method="POST">
          ...
          <input required type="hidden" value="<%= ens.getIdEnseignant() %>" id="enseignet" name="idense">
    <!-- Modal -->
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">Supprimer Enseignent </h4>
          </div>
          ...
          <div class="modal-footer">
            ...
            <button type="button" name="bt" value="suppenseignant" class="btn btn-primary">Oui</button>
