...
<html lang="en">
            ...
            <div id="content">
                <section class="style-default-bright">
                    <div class="section-header">
                        <h2 class="text-primary">Liste des modules</h2>
                    </div>
                                    ...
                                    <table id="datatable1" class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeX">
                                                ...
                                                <td><%=module.getIdClasse()%></td>
                                                <td><%=module.getIdSemester()%></td>

                                                <td class="text-right"><center>
                                            <a  href="Modifier_module.jsp?idmod=<%= module.getIdModule() %>"> 
    ...
    <a data-toggle="modal" href="#myModal<%=i%>" >
          <input required type="hidden" value="<%= module.getIdModule() %>" id="enseignet" name="idmod">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
           <P><h2>Voulez vous supprimer <%=module.getLibelle() %> ?</h2></P>
          </div>
          <div class="modal-footer">
            
            <button type="submit" name="bt" value="suppmod" class="btn btn-primary">Oui</button>
