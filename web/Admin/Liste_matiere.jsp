...
<html lang="en">
            ...
            <div id="content">
                <section class="style-default-bright">
                    <div class="section-header">
                        <h2 class="text-primary">Liste des matiéres</h2>
                    </div>
                                        ...
                                        <tbody>
                                            <%
                                                ...
                                                while (it_mat.hasNext()) {
                                                    ...
                                                    Iterator it_mod = gestion.listeModuleMatiere(matiere.getIdModule());
                                                    while (it_mod.hasNext()) {
                                                        Module mod = (Module) it_mod.next();

                                            %>
                                            <tr class="gradeX">
                                                <td><%=matiere.getLibelle()%></td>
                                                <td><%=mod.getLibelle()%></td>

                                                <td class="text-right"><center>  <a  href="Modifier_matiere.jsp?idmat=<%= matiere.getIdMatiere() %>"> 
    ...
    <form action="../SuppElement" method="POST">
          ...
          <input required type="hidden" value="<%= matiere.getIdMatiere() %>" id="enseignet" name="idmat">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
           <P><h2>Voulez vous supprimer : <%= matiere.getLibelle() %>?</h2></P>
          </div>
          <div class="modal-footer">
            
              <button type="submit"  name="bt" value="suppmatiere" class="btn btn-primary">Oui</button>
