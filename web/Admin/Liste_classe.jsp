...
<html lang="en">
            ...
            <div id="content">
                <section class="style-default-bright">
                    <div class="section-header">
                        <h2 class="text-primary">Liste des classes</h2>
                    </div>
                                ...
                                <div class="table-responsive">
                                    <table id="datatable1" class="table table-striped table-hover">
                                        <thead>
                                            <tr>
                                                <th>Classe</th>
                                                <th class="sort-alpha"><center>Gestion</center></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <% int i=0;
    ...
    <form action="../SuppElement" method="POST">
         <input required type="hidden" value="<%= classe.getIdClasse() %>" id="enseignet" name="idcl">
    <!-- Modal -->
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
           <P><h2>Voulez vous supprimer le Classe <%=i%>?</h2></P>
          </div>
          <div class="modal-footer">
            
            <button type="submit" name="bt" value="suppclasse" class="btn btn-primary">Oui</button>
