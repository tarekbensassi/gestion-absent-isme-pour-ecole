                ...
                <section>
                    ...
                    <div class="section-body">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <form class="form-horizontal" method="post" action="../ModifierClasse">
                                    <div class="card">
                                        <div class="card-head style-primary">
                                            <header>Modifier classe</header>
                                        </div>
                                        <input type="hidden" name="idens" value="<%=request.getQueryString().substring(request.getQueryString().indexOf("=")+1)%>">
                                        <div class="card-body">


                                            <div class="form-group">
                                                <label for="Firstname5" class="col-sm-2 control-label">Classe</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="libelleclasse" name="libelle">
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-actionbar">
                                            <div class="card-actionbar-row">
                                                <button type="submit" class="btn btn-flat btn-primary ink-reaction">Enregistrer</button>
