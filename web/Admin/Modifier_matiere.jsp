...
int idmod=0;
 Gestion g= new Gestion();
  Iterator it = g.listeMatiere();
   while (it.hasNext()) {
                Matiere et = (Matiere) it.next();
                if(et.getIdMatiere()==Integer.valueOf(idmat)){
                   lib=et.getLibelle();
                   idmod=et.getIdModule();
                }
   }
%>
        <!-- BEGIN HEADER-->
                ...
                <section>
                    ...
                    <div class="section-body">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <form class="form-horizontal" method="post" action="../Modifiermatiere">
                                    <input type="hidden" value="<%=idmat%>" name="idmat">
                                    <div class="card">
                                        <div class="card-head style-primary">
                                            <header>Modifier matiere</header>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text"  value="<%=lib%>" class="form-control" id="libellematiere" name="libelle">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="card-actionbar">
                                            <div class="card-actionbar-row">
                                                <button type="submit" name="bt" value="suppmatiere" class="btn btn-flat btn-primary ink-reaction">Enregistrer</button>
                                                <button type="reset" class="btn btn-flat btn-danger ink-reaction">Annuler</button>
                                            </div>
                                        </div>
                                    </div><!--end .card -->
