            ...
            <div id="content">
                ...
                <section class="style-default-bright">
                    <div class="section-header">
                        <h2 class="text-primary">Marquer l'absence des enseignants</h2>
                    </div>
                    <div class="section-body">
                        <div class="row">
                            <form action="../absenceEnseignant">
                                <div class="col-lg-12">
                                    <div class="table-responsive">
                                        <table id="datatable1" class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                %>
                                                <tr class="gradeX">
                                                    <td><input name="nom<%=i%>" value="<%= et.getIdEnseignant() %>" type="hidden" readonly>
                                                        <%=user.getNom()%> <%=user.getPrenom()%> </td>
